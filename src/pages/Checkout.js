                    ...
                    return(
                            <div className="cart_items" key={value.id}>
                                ...
                                <div className="plus_minus_btn_container">
                                    <button onClick={() => handleAddProduct(value)} style={{borderRadius: '15px 0 0 15px',background: 'green'}}> + </button>
                                    <button disabled style={{color: 'black'}}> { value.price +" X "+value.quantity} </button>
